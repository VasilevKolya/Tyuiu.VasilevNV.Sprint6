...
using Tyuiu.VasilevNV.Sprint6.Task3.V4.Lib;

namespace Tyuiu.VasilevNV.Sprint6.Task3.V4
{
    public partial class FormMain : Form
    {
        ...
        {
            MessageBox.Show("Таск 3 выполнила студент группы Испб24-1 Васильев Николай Владимирович", "Сообщение", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
